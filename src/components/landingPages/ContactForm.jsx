...
import bgImg from "../../assets/images/landingpage/landing-contactus.jpg";
...
const ContactForm = () => {
  ...
  return (
    <div
      id="contact"
      // bg-[100%_40%]
      className="py-[5rem] bg-cover bg-top  relative min-h-[40rem] flex items-center"
        ...
        >
          <div className="flex flex-col gap-1">
            <input
              type="text"
              placeholder="Name"
              className="outline-none text-white border-primary border bg-transparent p-2 rounded-sm shadow-large shadow-primary/30"
              {...register("name", {
