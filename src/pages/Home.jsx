  ...
  return (
    <>
      ...
      <section className="h-screen relative text-white">
        <div className="absolute top-0 w-full h-full bg-tertiary/30"></div>
        <img
          loading="lazy"
          src={bannerImg}
        ...
        >
          ...
          <h1 className="heading text-stroke">Alphenex Informatic LLP</h1>
          <p className="sub-heading">Innovating the Digital World</p>
        </div>
      </section>
      <div
        data-aos="fade-up"
      ...
      >
        <div className="bg-tertiary rounded-lg p-5">
          <div className="flex gap-3 mb-4">
            <img
              ...
              alt=""
            />
            <p className="text-lg leading-tight font-medium text-secondary">
        ...
        <div className="bg-tertiary rounded-lg p-5">
          ...
          <p className="desc !text-white">
            Revolutionize Your Business with Blockchain Expertise: Align
            Technology and Growth for Unparalleled Success
          </p>
        </div>
        <div className="bg-tertiary rounded-lg p-5">
          <div className="flex gap-3 mb-4">
            ...
            <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-start">
              ...
              >
                <img
                  ...
                  width="200"
                  height="200"
                  className="object-cover h-full max-h-[70vh] rounded-lg w-full"
                  alt=""
                />
              </div>
              <h2 className="heading-2 max-w-[60rem] mx-auto text-tertiary">
                Transforming Visions into Reality
              </h2>
              <p className="desc">
                At <b>ALPHENEX INFORMATIC</b>, we leverage the transformative
